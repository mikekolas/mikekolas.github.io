...
//     images_h[currentImage_H].className = 'mx-auto my-0 d-block image_h ';
//     currentImage_H = (currentImage_H+1)%images_h.length;
//     images_h[currentImage_H].className = 'mx-auto my-0 d-block image_h showing';
// }
//
